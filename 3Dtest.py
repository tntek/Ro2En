...
with torch.no_grad():
    ...
    #     # mlp_path = "models/source/3d/mlp/cae_offset03_encoder%d_mlp_100_4000_PReLU_ae_dd_final.pkl" % (ep+1)
    #     encoder_path = "models/source/3d/encoder/cae_encoder%d.pkl" % (ep+1)
    #     # encoder_path = "models/source/3d/encoder/cae_offsettimes03_encoder%d.pkl" % (ep+1)
