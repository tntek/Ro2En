...
def main(args):	
    ...
    encoder = Encoder()
    # encoder.load_state_dict(torch.load("models/source/cae_encoder4.pkl"))
    decoder = Decoder()
    # decoder.load_state_dict(torch.load("models/source/cae_decoder4.pkl"))
    ...
    torch.save(encoder.state_dict(),os.path.join(args.model_path,'source/3d/encoder/cae_encoder1.pkl'))
    torch.save(decoder.state_dict(),os.path.join(args.model_path,'source/3d/encoder/cae_decoder1.pkl'))
