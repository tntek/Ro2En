...
import os
# import pickle
from data_loader import load_3d_dataset
...
def get_input(i,data,targets,batch_size):
...
def main(args):
    ...
    # Build data loader
    dataset,targets= load_3d_dataset() 
    ...
    for epoch in range(args.num_epochs):
        ...
        for i in range (0,len(dataset),args.batch_size):
            ...
            bi=to_var(bi)	# input_x (100,34)
            bt=to_var(bt)	# target_y 	(100,3)
            bo = mlp(bi)	# output_y  (100,3)
    ...
    model_path='source/3d/mlp/cae_offsettimes03_encoder1_mlp_100_4000_PReLU_ae_dd_final.pkl'
    torch.save(mlp.state_dict(),os.path.join(args.model_path,model_path))
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_size', type=int , default=96, help='dimension of the input vector')
